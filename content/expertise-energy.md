...
*How decentralised energy reaches the hundreds of millions still beyond the grid, and whether it reaches them fairly and durably.*

<!-- IMAGE energy-hero: hero photo | Solar mini-grid, home solar panel, or a technician installing off-grid power in a rural setting. Real, working, daylight. | Full-width hero under the standfirst. -->

Energy access underpins most other transitions, and it is the one where progress has stalled hardest.

It is the only region-scale story in the world where, in some years, the number of people without power has risen rather than fallen.
...
## The bottleneck is trust and delivery, not hardware
...
- Who decentralised energy reaches first, and who is reached last.
- What blocks locally-owned energy companies from scaling.
- Whether access translates into productive use, or stops at the lightbulb.
- Clean cooking, the most neglected part of the gap.
...
*Related reading: [The Smelter Contract](/insight-the-smelter-contract) on what sixty years of anchor-load bargains should tell anyone signing one, [Nobody Buys a Chiller](/insight-nobody-buys-a-chiller) on the counterfactual at the centre of efficiency-as-a-service, [Paying for Power You Curtail](/insight-paying-for-what-we-curtail) on why clean generation and cheap electricity are not the same thing, [Who Pays Decides What Gets Built](/insight-who-pays-decides) on the hyperscaler class now setting the direction of firm clean generation, and [The Load That Grows When It Is Hot](/insight-load-that-grows-when-hot) on why cooling-driven data centre demand is not baseload. For the full series, see [Articles](/articles).*
