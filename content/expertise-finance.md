...
<div class="sdg-block">
  ...
  <ul class="sdg-row">
    <li class="sdg-01"><a href="/sdgs#g1"><img class="sdg-icon" src="/assets/img/sdg/sdg-01.png" alt="SDG 1"><span class="sdg-name"><span class="sdg-goal-title">Goal 1: No Poverty</span><span class="sdg-tailored">Financing that reaches households</span></span></a></li>
    <li class="sdg-08"><a href="/sdgs#g8"><img class="sdg-icon" src="/assets/img/sdg/sdg-08.png" alt="SDG 8"><span class="sdg-name"><span class="sdg-goal-title">Goal 8: Decent Work and Economic Growth</span><span class="sdg-tailored">Instruments matched to cash flow</span></span></a></li>
    <li class="sdg-10"><a href="/sdgs#g10"><img class="sdg-icon" src="/assets/img/sdg/sdg-10.png" alt="SDG 10"><span class="sdg-name"><span class="sdg-goal-title">Goal 10: Reduced Inequalities</span><span class="sdg-tailored">Who is left outside credit</span></span></a></li>
  </ul>
</div>
...
- Mobile money brought [**hundreds of millions**](https://www.gsma.com/mobilefordevelopment/mobile-money/) of previously unbanked people into digital finance (GSMA), with East Africa leading globally.
- But an [**account is not credit**](https://www.worldbank.org/en/publication/globalfindex), and access is not benefit (World Bank Global Findex): fees, over-indebtedness and exclusion persist beneath the headline numbers.
...
<div class="reading-group">
  <h3>Asset finance and default risk</h3>
  <div class="reading-cards">
    <a href="/insight-what-the-bond-secures">
      <h4>What the Bond Is Actually Secured On</h4>
      <p>Securitisation in PAYGo solar, and what the collateral really is.</p>
      <span class="read-cue">Read &rarr;</span>
    </a>
    <a href="/insight-wrong-money-for-a-warehouse">
      <h4>Equity Is the Wrong Money for a Warehouse</h4>
      <p>Matching the instrument to the shape of the cash flow.</p>
      <span class="read-cue">Read &rarr;</span>
    </a>
    <a href="/insight-strategic-not-financeable">
      <h4>Strategic Is Not the Same as Financeable</h4>
      <p>The decision bar that a subsidy does not move.</p>
      <span class="read-cue">Read &rarr;</span>
    </a>
  </div>
</div>
...
<div class="reading-group">
  <h3>Who gets included and who does not</h3>
  <div class="reading-cards">
    ...
    <a href="/insight-evidence-arrives-too-early">
      <h4>The Evidence Arrives Too Early</h4>
      <p>Where a long-horizon risk crosses into a short-horizon mandate on its own.</p>
      <span class="read-cue">Read &rarr;</span>
    </a>
    <a href="/insight-when-is-a-mine-green">
      <h4>When Is a Mine Green Infrastructure?</h4>
      <p>A classification question that is really a distributional one.</p>
      <span class="read-cue">Read &rarr;</span>
    </a>
  </div>
</div>
...
<div class="contact-cta-programme">
  <h3>Independent evidence on financial inclusion.</h3>
  <p class="lede">If you are designing or backing an instrument that decides who a transition reaches, tell us the decision you are facing.</p>
