...
<figure>
<img src="/assets/img/insight-lock-in-both-ways-diagram.jpg" alt="A left-to-right sequence of seven boxes — samples, characterisation, cell builds, cycling, pilot line, validation, and a bright orange supply box on the right — sitting above a long orange bar labelled plant capital committed with no revenue, and a dashed loop-back arrow marked any process change can send you back." class="diagram">
<figcaption>The barrier is not that the entrant cannot make the material. It is that nobody will buy it until years after the plant has been paid for.</figcaption>
</figure>
...
**The chemistry is losing share.** The IEA reports that lithium iron phosphate batteries [now supply almost half the global electric car market, up from less than 10 per cent in 2020, at the expense of the previously dominant nickel based NMC chemistries](https://www.iea.org/reports/global-critical-minerals-outlook-2025/beyond-nmc-batteries-supply-chain-issues-for-emerging-battery-technologies), driven by improved performance and lower costs. LFP also accounted for [over 90 per cent of global stationary battery storage installations in 2025](https://www.iea.org/reports/global-ev-outlook-2026/electric-vehicle-batteries). NMC retains a substantial position, particularly at the premium and long range end, where high nickel variants together with NCA [accounted for roughly 80 per cent of 2025 electric vehicle battery deployment using cobalt containing chemistries](https://www.iea.org/reports/global-ev-outlook-2026/electric-vehicle-batteries). But the direction is not ambiguous, and LFP contains neither cobalt nor nickel.

**The step itself may be disappearing.** This is the more serious risk and it is barely discussed. The IEA notes that [processes producing cathode active material without using precursors are being developed, which could reduce exposure to geographically concentrated supply chains, though they pose greater challenges in ensuring the required consistency in material characteristics](https://www.iea.org/reports/global-ev-outlook-2026/electric-vehicle-batteries). A precursor plant is an investment in a stage of the process that some producers are working to eliminate.
