...
# The Factory Cannot Transition Without the Town
...
<p class="article-meta"><span class="article-date">11 September 2026</span> · <span class="article-reading-time">4 min read</span></p>

<figure>
<img src="/assets/img/insight-factory-and-the-town-hero.jpg" alt="Line-art scene: a large steelworks with cooling towers and a blast furnace drawn in outline at the top of the frame, and beneath it, connected by fine radiating lines, a dense town of small buildings including a school, a bakery, a machine shop, a bus and rows of houses, so that the works and the town read as one structure." class="diagram">
<figcaption>The lines only run one way. That is what makes this hard.</figcaption>
</figure>


## Taranto, and the evidence that retraining was never going to be enough
...
## What the evidence says happens to these workers
...
Jacobson, LaLonde and Sullivan used administrative earnings data from Pennsylvania in the 1980s to follow workers who left distressed firms after long service. Their findings, published as [Earnings Losses of Displaced Workers](https://ideas.repec.org/p/upj/weupjo/92-11.html), are stark. High-tenure workers separating from distressed firms [suffered long-term losses averaging twenty-five per cent per year](https://www.chicagofed.org/publications/economic-perspectives/1993/14novdec1993-part1-jacobson). The losses [began mounting before the separation](https://www.chicagofed.org/publications/economic-perspectives/1993/14novdec1993-part1-jacobson), depended [more on local labour market conditions and the former industry than on age or sex](https://www.chicagofed.org/publications/economic-perspectives/1993/14novdec1993-part1-jacobson), and were [large even for those who found new jobs in similar firms](https://www.chicagofed.org/publications/economic-perspectives/1993/14novdec1993-part1-jacobson).
...
## Which is why the supplier economy is the larger number
...
## What the sequence has to be, and why it usually is not
...
## What a serious transition package would contain
...
The Lab works on this in [local manufacturing](/expertise-manufacturing) and through [field research](/entering-a-new-context) with the workers and suppliers a transition lands on.

If you are designing a just transition package and want the harm measured as the evidence describes it, [tell us what you need to know](/contact).

---

## Sources

- Italian court ruling on the Taranto blast furnaces (as reported), September 2026.
- Jacobson, L. S., LaLonde, R. J. and Sullivan, D. G. (1993), [Earnings Losses of Displaced Workers](https://ideas.repec.org/p/upj/weupjo/92-11.html), *American Economic Review* 83(4), 685 to 709. [Freely available companion article](https://www.chicagofed.org/publications/economic-perspectives/1993/14novdec1993-part1-jacobson), *Economic Perspectives*, Federal Reserve Bank of Chicago.

---

*This is an independent insight piece by Transitions Lab. For the Lab's applied work, see [Local Manufacturing & Supply Chains](/expertise-manufacturing). See also [Capability Is the Slow Part](/insight-capability-slow-part) on capability that takes decades and can be lost in years, and [Strategic Is Not the Same as Financeable](/insight-strategic-not-financeable) on the investment decision that determines whether a replacement ever gets built. To discuss a study, see [Contact](/contact).*
