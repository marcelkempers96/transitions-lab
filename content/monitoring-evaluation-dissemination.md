...
**Theory of change and the results chain.** Every design begins by making the project's causal logic explicit: the chain from inputs and activities to outputs, outcomes, and impact. This is the backbone of results-based management and the logical framework tradition (Kellogg Foundation, 2004; UNDP, 2009). Naming the chain in advance is what lets you test it later, rather than asserting success after the fact.

**The OECD-DAC evaluation criteria.** The Lab judges interventions against the six internationally standard criteria: relevance, coherence, effectiveness, efficiency, impact, and sustainability (OECD-DAC, adopted 1991; coherence added in the 2019 revision; see OECD, 2021, Applying Evaluation Criteria Thoughtfully). These give donors and evaluation teams a shared language for asking not just "did it work?" but "was it the right thing to do, and will the benefits last?" They are applied thoughtfully and weighted to context, not mechanically, as the OECD's own guidance insists.
