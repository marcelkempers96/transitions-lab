...
*How electric two-wheelers move from novelty to default in a market built entirely around petrol, read from the daily arithmetic of the Nairobi boda-boda riders who are actually switching over.*
...
<figure>
  <img src="/assets/img/case-roam-mechanics.png" alt="A Nairobi roadside scene at first light: a red Boxer 100 boda-boda propped on its side stand next to a green-and-red boda-boda, a mechanic in an orange top squatting between them working on a chain, another rider in a high-vis vest and a helmet leaning over one of the bikes; a blue lorry in the background, dusty red-earth ground and a busy junction beyond." class="diagram">
...
### The economics are the adoption story
...
<figure>
  <img src="/assets/img/case-roam-market-stall.png" alt="A bright-orange NGONYA electric motorcycle parked in front of a small Nairobi hardware kiosk with a corrugated green roof and a Toyota Genuine Parts sign; twin detachable battery boxes visible under the seat, an orange helmet resting on the tank; three mechanics sitting to one side, one changing a wheel, another cradling a small child in a faded blue Youth Self Help Group doorway." class="diagram">
  <figcaption>An electric two-wheeler at a shopfront. The dual-battery pack is the range answer in physical form; whether the rider thinks about it during the day is the real test.</figcaption>
</figure>
...
<figure>
  <img src="/assets/img/case-roam-cheche-show.png" alt="A Cheche electric-motorbike trade-show booth under a red-and-white striped canopy; a young man in a black polo shirt hands a leaflet to a booth attendant in a red Cheche polo standing behind a matte-grey electric motorcycle on a raised white platform; a Head of State to Own Electric Vehicle banner behind the bike; a stack of yellow battery-swap lockers to the left; an attendee seated behind the counter." class="diagram">
  <figcaption>The public-facing side of the transition: a trade-show handover translating the daily-cost argument to buyers, financiers and fleet operators one leaflet at a time.</figcaption>
</figure>
...
This case sits inside the Lab's electrification programme as a live instance of a general pattern: a niche technology navigating an entrenched petrol regime not by confronting it head-on, but by quietly out-competing it on the one metric the user actually optimises, daily cost, while building, piece by piece, the financing and service infrastructure that lets ordinary people make the switch without taking on ruinous risk.

The motorcycle was never the hard part. The hard part is everything around it. That is the part worth studying.

---

*This case study is part of the Lab's [E-Mobility & Transport](/expertise-e-mobility) programme. For the Lab's field methods, see [Field Research](/field-research). To discuss a study in your own market, see [Contact](/contact). See also [Own the Battery, Rent the Shopfront](/insight-own-the-battery) on the make-or-buy decision inside a swap network, and [Who Holds the Pen on the Standard](/insight-who-holds-the-pen) on the governance of Kenya's open battery-swap network.*
