...
<figure>
<img src="/assets/img/insight-who-buys-the-outcome-hero.jpg" alt="Line-art scene: a single farmer standing in a field holding one invoice, with five separate arrows running from the field outward to a water utility building, a town hall, an insurance office, a food company warehouse and a distant row of houses; only one thin line returns to the farmer's hand." class="diagram">
<figcaption>Five beneficiaries, one invoice, and it is addressed to whoever happened to show up.</figcaption>
</figure>


## Carbon farming has a market design problem, not a measurement problem
...
## One action, several outputs, several beneficiaries
...
## Why that invoice does not exist on its own
...
**Persistence after the first contract term.** Whether practices continue when a buyer exits, which is the [persistence question](/insight-trough-before-the-dividend) that determines whether any of this produced a durable change in a landscape.
...
The Lab works on this in [regenerative agriculture](/expertise-agriculture) and [climate and ecosystems](/expertise-climate), and on who bears the cost of a practice change through [field research](/entering-a-new-context).

If you are designing a payment scheme whose benefits accrue to people who are not party to the contract, [tell us what you need to know](/contact).

---

## Sources

- European Commission EU Carbon Removals and Carbon Farming Buyers Club (as reported), September 2026.

---

*This is an independent insight piece by Transitions Lab. For the Lab's applied work, see [Regenerative Agriculture](/expertise-agriculture). See also [The Distance Between the Work and the Reward](/insight-distance-work-reward) on what the weight of a verification system tells you about a deal, [Whose Field Becomes a Wetland](/insight-whose-field-becomes-a-wetland) on concentrated costs and diffuse benefits, and [The Trough Before the Dividend](/insight-trough-before-the-dividend) on why persistence is the only real test. To discuss a study, see [Contact](/contact).*
