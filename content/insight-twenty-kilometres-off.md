...
The Joint Research Centre and DG INTPA have been running a programme called Corridors and Urban Systems in Africa, which underpins the Global Gateway corridor investments. Its most recent output is a [pilot analysis of Abidjan and Ouagadougou](https://publications.jrc.ec.europa.eu/repository/handle/JRC146834), the two largest cities on West African Global Gateway Transport Corridor No. 2, covering demography, socio-economic development, access to services, transport and connectivity and environmental vulnerability.

The programme's ambition is unusually broad for transport work. The first phase employed [more than 140 quantitative indicators](https://publications.jrc.ec.europa.eu/repository/handle/JRC128942) to identify 55 strategic corridors, narrowed to a shortlist of 11 using 32 indicators covering economic welfare, equity, social inclusion, environmental impact and impact on vulnerable groups. That is a considerably better instrument than kilometres and travel times, and it deserves saying, because the criticism that follows is not that nobody is measuring.
...
Paul Nugent's chapter on the Abidjan to Lagos route, in the collection [*Transport Corridors in Africa*](https://www.jstor.org/content/oa_book_edited/j.ctv2x4kp3n), makes a point that ought to be uncomfortable for any corridor programme. Almost all corridors are [labels placed upon routes that already existed](https://www.jstor.org/content/oa_book_edited/j.ctv2x4kp3n), often for a very long time, and most analysis infers what a corridor is from its effects rather than from any intrinsic property.
...
A World Bank assessment of [Burkina Faso's regional connectivity](https://hdl.handle.net/10986/33040) found that the Ouagadougou to Lomé corridor serves as the artery for about 40 per cent of all cargo entering the country, while the Ouagadougou to Abidjan road and rail corridors play their crucial role in allowing Burkina Faso's exports to reach global markets.
...
The Lab works on this through [entering a new context](/entering-a-new-context) and [measuring change](/measuring-change), and the distributional questions here are the ones we ask in [the places](/who-we-serve) where an infrastructure decision lands on a household rather than a map.

If you are financing or evaluating a corridor and need the off-corridor comparison built before construction starts, [tell us what you need to know](/contact).

---

## Sources

- Joint Research Centre and DG INTPA, [Urban systems in Africa: Abidjan and Ouagadougou metropolitan areas](https://publications.jrc.ec.europa.eu/repository/handle/JRC146834), Corridors and Urban Systems in Africa, 2025.
- Joint Research Centre, [Identification, characterisation and ranking of strategic corridors in Africa](https://publications.jrc.ec.europa.eu/repository/handle/JRC128942), CUSA phase one.
- Joint Research Centre, [Global Gateway Support to Transport Corridors in Africa, consolidated report](https://publications.jrc.ec.europa.eu/repository/bitstream/JRC142789/JRC142789_01.pdf).
- Nugent, P., "When Is a Corridor Just a Road? Understanding Thwarted Ambitions Along the Abidjan-Lagos Corridor", in [*Transport Corridors in Africa*](https://www.jstor.org/content/oa_book_edited/j.ctv2x4kp3n), open access.
- World Bank (2019), [Enhancing Burkina Faso Regional Connectivity: An Economic Corridor Approach](https://hdl.handle.net/10986/33040).

---

*This is an independent insight piece by Transitions Lab. For the Lab's applied work, see [Measuring Change](/measuring-change). See also [The EU and Africa](/insight-eu-africa) on the distance between European commitment and measured outcome, [Behind the Border](/insight-behind-the-border) on why variance rather than distance is what stops firms trading, and [Europe Has Enough Demonstrations](/insight-enough-demonstrations) on sampling the people a programme did not reach. To discuss a study, see [Contact](/contact).*
