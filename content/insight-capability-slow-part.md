...
*This is an independent insight piece by Transitions Lab. For the Lab's applied work, see [Local Manufacturing &amp; Supply Chains](/expertise-manufacturing) and [Energy Access &amp; Off-Grid Systems](/expertise-energy). See also [Paying for Power You Curtail](/insight-paying-for-what-we-curtail), which reads the same slow-implementation problem at the level of a single national grid, and [The Value Is in the Second Step](/insight-second-step) on why operations capability is the part that has to be built rather than procured. To discuss a study, see [Contact](/contact).*
