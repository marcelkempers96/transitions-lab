...
## Smith's proposition, and why it binds here
...
## What a cross-border chain actually requires
...
## The risk in the anchor project approach
...
We set out that risk about [battery precursor investment](/insight-lock-in-both-ways) specifically: lithium iron phosphate has taken a large share of the market and contains no cobalt, and some producers are developing routes that skip the precursor stage entirely. A continental chain designed around nickel manganese cobalt is a bet on a chemistry, and the bet should be stated as one.
...
**Whether smaller firms can enter.** An anchor project can build an industrial ecosystem or a single integrated complex with a fence around it. Whether local suppliers and smaller processors can access the infrastructure on published terms is the difference, and it is the [third party access question](/insight-ban-is-not-the-policy) that determines who benefits from every instrument of this kind.
...
The Lab works on this in [local manufacturing](/expertise-manufacturing) and across [the markets](/who-we-serve) where cross-border industrial chains are being attempted.

If you are assessing a regional industrial project whose viability depends on a border working, [tell us what you need to know](/contact).

---

## Sources

- AfCFTA Secretariat proposals for cross-border industrial anchor projects (as reported), September 2026.
- Smith, A. (1776), *An Inquiry into the Nature and Causes of the Wealth of Nations*, Book I, Chapter III: That the Division of Labour Is Limited by the Extent of the Market.

---

*This is an independent insight piece by Transitions Lab. For the Lab's applied work, see [Local Manufacturing & Supply Chains](/expertise-manufacturing). See also [Behind the Border](/insight-behind-the-border) on why variance rather than distance forecloses specialisation, [The Lock-In Runs Both Ways](/insight-lock-in-both-ways) on the qualification barrier and the chemistry risk in battery materials, and [The Ban Is Not the Policy](/insight-ban-is-not-the-policy) on access terms deciding who benefits. To discuss a study, see [Contact](/contact).*
