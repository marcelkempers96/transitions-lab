...
# Strategic Is Not the Same as Financeable
...
<figure>
<img src="/assets/img/insight-strategic-not-financeable-hero.jpg" alt="Line-art scene: a processing plant drawn in outline as an unbuilt proposal on a drawing board, with a large ornate stamp reading STRATEGIC pressed across it, while beside the board a banker's desk holds a closed ledger and a calendar with no date circled." class="diagram">
<figcaption>The designation is real. So is the calendar with nothing on it.</figcaption>
</figure>


## Why a designation and a subsidy do not move a final investment decision
...
The textbook rule is that a firm should invest when the net present value of a project is positive. Avinash Dixit and Robert Pindyck's [*Investment under Uncertainty*](https://press.princeton.edu/books/hardcover/9780691034102/investment-under-uncertainty) set out why that rule systematically fails to describe what firms actually do, and the explanation has three components.
...
## Which means the instrument matters more than the amount
...
<aside class="tl-box">
<p><strong>A strategic designation can make waiting more attractive, not less.</strong></p>
<p>There is an awkward second-order effect that nobody in this process has an incentive to mention.</p>
<p>Being named a strategic project is a signal that the state considers the asset important. A rational developer should update on that in two ways. First, the project is more likely to receive support. Second, and less comfortably, it is more likely to receive <em>more</em> support later, because a government that has publicly designated sixty projects and watched twenty-three stall is under pressure to act.</p>
<p>If a developer believes the terms available in eighteen months will be better than the terms available now, waiting has just become more valuable, and the designation itself caused it. The stronger the political commitment to the list, the stronger the incentive for anybody on it to hold out.</p>
<p>This is not cynicism about developers. It is the ordinary consequence of announcing a commitment before deciding the instrument, and the remedy is well known in other domains: state the terms, state that they will not improve, and mean it. Very few governments manage the third part.</p>
</aside>

---

## What a readiness assessment would need to add
...
The Lab works on this in [local manufacturing](/expertise-manufacturing) and [financial inclusion](/expertise-finance), and on the distance between a policy commitment and an operating asset through [measuring change](/measuring-change).

If you are designing support for projects that are stuck before a final investment decision, [tell us what you need to know](/contact).

---

## Sources

- Reporting on financing constraints among the EU's designated strategic critical raw material projects (as reported), September 2026.
- Dixit, A. K. and Pindyck, R. S. (1994), [*Investment under Uncertainty*](https://press.princeton.edu/books/hardcover/9780691034102/investment-under-uncertainty), Princeton University Press.

---

*This is an independent insight piece by Transitions Lab. For the Lab's applied work, see [Financial Inclusion & Investment](/expertise-finance). See also [The Hurdle Is Not the Risk](/insight-hurdle-not-risk) on why a de-risking instrument may address the wrong band, [The Mandate Is the Mine](/insight-the-mandate-is-the-mine) on demand that exists only because a regulation created it, and [Capability Is the Slow Part](/insight-capability-slow-part) on the difference between a commitment and an operating industry. To discuss a study, see [Contact](/contact).*
