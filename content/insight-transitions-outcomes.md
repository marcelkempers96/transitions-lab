...
- **Singapore's public-housing electrification.** HDB manages [roughly 80% of Singapore residents' housing](https://www.hdb.gov.sg/about-us/history), and its own [Green Towns and smart programmes](https://www.hdb.gov.sg/about-us/our-role/smart-and-sustainable-living/hdb-greenprint) direct efficiency upgrades and rooftop-solar deployment across the entire stock at once. The niche innovators exist, but the pace is set by the estate manager.
