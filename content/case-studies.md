...
The Lab's published research and its applied engagements share one root: direct contact with the people a transition affects. The cases below show the range, electric transport, decentralised clean energy, marine monitoring, and the constant: a reading that starts from the human side and brings technical depth alongside it.

Most of the Lab's commissioned work is never published. It is delivered to the client as a confidential internal report and stays private. The case studies here are the exception, the engagements partners have agreed to share. They are a window onto how the Lab works, not the whole of what it does.

<!-- IMAGE cases-hero: 3 photos | Three landscape cover photos, one per case (Roam e-motorcycle in Nairobi; Pyropower kiln/biochar in Lombok; Reef Support ranger/reef). These double as the card images linking to each case. | Under the intro, as the three case cards. -->

Each case is written to show not only what a technology does, but whether and how it crosses into ordinary use, who it serves, and who it leaves out.

---

**§ 1.1 / Electrification & e-mobility**
...
[Read the case →](https://www.transitionslab.org/case-pyropower.html)

---

**§ 1.3 / Marine ecosystems & community monitoring**
...
[Read the case →](https://www.transitionslab.org/case-statia.html)
