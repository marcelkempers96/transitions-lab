...
Tariff escalation is the practice of applying higher duties to processed goods than to the raw materials they are made from. [UN Trade and Development](https://unctad.org/) describes it plainly in the context of critical minerals: escalation [discourages value-added exports and locks producers into the role of raw material suppliers](https://unctad.org/publication/global-trade-update-may-2025-critical-minerals-copper). The effect is to tax exactly the step a country is trying to climb.

[Raúl Prebisch](https://repositorio.cepal.org/handle/11362/29973) and [Hans Singer](https://www.jstor.org/stable/1818065) built an entire school of development economics on the observation that primary exporters tend to lose ground in relative terms to exporters of manufactures. The policy conclusion drawn from it in the 1960s, broad import substitution behind high walls, mostly failed and deserves its reputation. The underlying diagnosis about the composition of exports has aged considerably better than the prescription, and this week's two projects are that diagnosis being acted on with better instruments.
...
UNCTAD finds that tariff escalation is [widely in place within Africa and other developing economies](https://www.gtreview.com/news/africa/tariff-escalation-holding-back-african-industrialisation-un-finds/), not only in the markets they export to. African exporters can face lower tariffs in developed markets, where preferential agreements apply, than [within their own region](https://unctad.org/news/tariff-escalation-keeps-developing-economies-moving-global-value-chains). Some of the barrier to African value addition is erected by African tariff schedules.
...
<div class="callout c-cobalt">
  <span class="kicker">Climbing the chain raises two things at once</span>
  <p>Both value chains this week are attempts to move one step to the right.</p>
  <ul>
    <li><strong>Copper:</strong> ore &rarr; concentrate &rarr; refined cathode.</li>
    <li><strong>Renewable power:</strong> electricity &rarr; hydrogen &rarr; ammonia.</li>
  </ul>
  <p>Each step to the right raises the requirement for firm continuous power. It also raises the tariff typically applied to the exported product. Solving the first does not touch the second. This week's two projects address only the top row.</p>
</div>
...
A refinery or an electrolyser complex requires a workforce that can run it for thirty years. That is the [slow part](/insight-capability-slow-part); it cannot be procured with the equipment, and whether it is built locally or imported for the life of the plant is a policy choice usually made inside a procurement document.
...
The Lab works on this in [local manufacturing](/expertise-manufacturing) and [energy access](/expertise-energy), across the markets where processing is being attempted for the first time.

If you are developing a processing complex and want the regional consequences understood before commissioning, [tell us what you need to know](/contact).

---

## Sources

- [CrossBoundary Energy](https://www.crossboundary.com/energy/), Kamoa-Kakula solar and storage plant enters commercial operation, 25 August 2026 (nameplate, storage and firm-supply figures are as reported by the company).
- [KBR](https://www.kbr.com/), selected for pre-FEED on ORNX Green Hydrogen project near Laayoune, Morocco, supported by the [US Trade and Development Agency](https://ustda.gov/), August 2026 (electrolyser capacity and annual output are as reported).
- UNCTAD, [Global Trade Update: critical minerals and copper](https://unctad.org/publication/global-trade-update-may-2025-critical-minerals-copper), May 2025.
- UNCTAD, [Tariff escalation keeps developing economies from moving up global value chains](https://unctad.org/news/tariff-escalation-keeps-developing-economies-moving-global-value-chains), March 2025.
- Global Trade Review, [Tariff escalation holding back African industrialisation, UN finds](https://www.gtreview.com/news/africa/tariff-escalation-holding-back-african-industrialisation-un-finds/), July 2025.

---

*This is an independent insight piece by Transitions Lab. For the Lab's applied work, see [Local Manufacturing & Supply Chains](/expertise-manufacturing) and [Energy Access & Off-Grid Systems](/expertise-energy). See also [Behind the Border](/insight-behind-the-border) on why variance rather than tariff is what forecloses regional specialisation, [The Lock-In Runs Both Ways](/insight-lock-in-both-ways) on the qualification barrier that governs the step after refining, [The Mandate Is the Mine](/insight-the-mandate-is-the-mine) on where a synthetic fuel plant's demand actually comes from, and [The Survey Is the First Act of the Mine](/insight-survey-first-act-of-the-mine) on why owning the geological information decides the terms of everything downstream. To discuss a study, see [Contact](/contact).*
