...
# Europe Has Enough Demonstrations
...
## What a pilot can and cannot tell you about what will scale

Two European items landed this week that belong in the same argument.

The Commission's latest [MARS assessment](https://joint-research-centre.ec.europa.eu/monitoring-agricultural-resources-mars_en) finds that persistent heat and water deficits have substantially reduced summer crop prospects across western and central Europe, with forecasts cut for all major summer crops and some falling as much as 14 per cent below their five year averages, alongside deteriorating pasture and fodder availability.

Separately, a Commission-backed [Adaptation and Nature Forum](https://climate-adapt.eea.europa.eu/) on 27 August brought together more than 450 researchers, local authorities, practitioners and policymakers around results from [LIFE projects](https://cinea.ec.europa.eu/programmes/life_en), reaching a conclusion worth quoting in substance: Europe has accumulated enough demonstrations, and the next challenge is deployment at scale, including collaboration with farmers, landowners, communities and municipalities, and demonstrating social as well as environmental benefits.
...
<div class="callout c-butter">
  <span class="kicker">What a demonstration measures and what scaling encounters</span>
  <p>Each row is a reason the pilot result will not reproduce at scale.</p>
  <ul>
    <li><strong>Who participates.</strong> Demonstration: volunteers. At scale: the median farm.</li>
    <li><strong>Who delivers it.</strong> Demonstration: the project team. At scale: an advisory service with a caseload.</li>
    <li><strong>Capital cost.</strong> Demonstration: covered. At scale: co-financed at best.</li>
    <li><strong>Advisory contact.</strong> Demonstration: intensive. At scale: a leaflet.</li>
    <li><strong>Exposure to a bad year.</strong> Demonstration: unlikely in three to five years. At scale: certain, eventually.</li>
    <li><strong>Catchment interaction.</strong> Demonstration: one farm, no interaction. At scale: everyone at once, and water is shared.</li>
  </ul>
  <p>None of these concern the practice itself, which is why more agronomic evidence does not close the gap.</p>
</div>

---

## The distributional consequence nobody is naming
...
The same structure appears wherever the capacity to adopt is unequal. It is the argument we made about [rice methane practice](/insight-distance-work-reward) and about [who can afford to plant a tree](/insight-right-to-the-tree), arriving in the Mediterranean.

---

## What an adoption study would need to do differently
...
The Lab works on this in [regenerative agriculture](/expertise-agriculture) and [climate and ecosystems](/expertise-climate), through [field research](/field-research) designed around non-adopters rather than participants, across the regions where the comparison to European conditions is informative rather than ornamental.

If you are building an adaptation work package and need the adoption evidence rather than more feasibility evidence, [tell us what you need to know](/contact).

---

## Sources

- European Commission, Joint Research Centre, [MARS crop monitoring assessment](https://joint-research-centre.ec.europa.eu/monitoring-agricultural-resources-mars_en) (as reported), August 2026.
- Adaptation and Nature Forum, LIFE programme results, [Climate-ADAPT](https://climate-adapt.eea.europa.eu/) (as reported), 27 August 2026.
- Feder, G., Just, R. E. and Zilberman, D. (1985), [Adoption of Agricultural Innovations in Developing Countries: A Survey](https://www.semanticscholar.org/paper/Adoption-of-Agricultural-Innovations-in-Developing-Feder-Just/f23b66902a0562b60310c76ecd884f53159bb79f), *Economic Development and Cultural Change* 33(2), 255 to 298.
- Ruzzante, S., Labarta, R. and Bilton, A. (2021), [Adoption of agricultural technology in the developing world: a meta-analysis of the empirical literature](https://www.sciencedirect.com/science/article/pii/S0305750X2100214X), *World Development*.

---

*This is an independent insight piece by Transitions Lab. For the Lab's applied work, see [Regenerative Agriculture & Agri-Tech](/expertise-agriculture) and [Climate & Ecosystems](/expertise-climate). See also [Distance, Work, Reward](/insight-distance-work-reward) on rice methane practice and the geometry of adoption, [The Right That Matters Is to the Tree](/insight-right-to-the-tree) on why capital and permission decide who plants, [The Fire Was Put Out by People Making a Living](/insight-fire-and-livelihood) on why grazing pilots do not become adoption without the livelihood underneath, [A Recycled Material Is a Promise](/insight-recycled-is-a-promise) on the pattern of demonstration versus adoption running through European circular research, [The Municipality Is the Instrument](/insight-municipality-is-the-instrument) on the last-mile implementing capacity that scaling assumes, [The Village Twenty Kilometres Off the Road](/insight-twenty-kilometres-off) on sampling the people a programme did not reach, [The Trough Before the Dividend](/insight-trough-before-the-dividend) on why case-study economics are conditional on persistence and miss the farms that reverted, and [Adoption Is Not the End of the Research](/insight-adoption-is-the-research) on why uptake has to be treated as a research question rather than a communications budget. To discuss a study, see [Contact](/contact).*
