...
Ember and the African Tech Futures Lab have published estimates showing that Africa will install a [record 17 gigawatts of solar in 2026](https://ember-energy.org/latest-insights/the-take-off-in-african-solar-that-official-statistics-cant-yet-see/), up 45 per cent year on year and the third consecutive record, equivalent to around a hundred thousand panels a day. [Thirty six of Africa's fifty four countries](https://ember-energy.org/latest-insights/the-take-off-in-african-solar-that-official-statistics-cant-yet-see/) are expected to install record amounts, with [nineteen countries growing more than 100 per cent](https://ember-energy.org/latest-insights/the-take-off-in-african-solar-that-official-statistics-cant-yet-see/) year on year, including [544 per cent in the Democratic Republic of Congo](https://ember-energy.org/latest-insights/the-take-off-in-african-solar-that-official-statistics-cant-yet-see/), 282 per cent in Zimbabwe, 176 per cent in Egypt and 117 per cent in Zambia. South Africa's share of African installations will [fall below a fifth](https://ember-energy.org/latest-insights/the-take-off-in-african-solar-that-official-statistics-cant-yet-see/) for the first time since 2019.
...
<figcaption>Solar capacity installed annually, 2023 to 2026, in megawatts. Chart by <a href="https://ember-energy.org/latest-insights/the-take-off-in-african-solar-that-official-statistics-cant-yet-see/">Ember and the African Tech Futures Lab</a>, reproduced under Creative Commons Attribution.</figcaption>
</figure>


This is not a marginal development and it should not be read as one. Senegal will add solar capacity between 2023 and 2026 equivalent to [almost 80 per cent of its entire 2023 grid capacity](https://ember-energy.org/latest-insights/the-take-off-in-african-solar-that-official-statistics-cant-yet-see/), with the DRC and Kenya each adding more than half. The 2026 installations will generate around [23 terawatt hours](https://ember-energy.org/latest-insights/the-take-off-in-african-solar-that-official-statistics-cant-yet-see/) a year, which is [2.3 per cent](https://ember-energy.org/latest-insights/the-take-off-in-african-solar-that-official-statistics-cant-yet-see/) of Africa's electricity generation, slightly above the 2.2 per cent average annual demand growth of the previous decade.
...
Ember's estimates are not built from African statistics, because those largely do not exist. Official national solar capacity reporting could be found for [only 36 of 54 countries](https://ember-energy.org/latest-insights/the-take-off-in-african-solar-that-official-statistics-cant-yet-see/), only 14 of those covered 2025, and only three, South Africa, Tunisia and Tanzania, publish solar data monthly or quarterly. Ember's 2025 estimate of [12.0 gigawatts](https://ember-energy.org/latest-insights/the-take-off-in-african-solar-that-official-statistics-cant-yet-see/) is roughly double the International Energy Agency's 6.2 and more than double IRENA's 4.6.

The estimates are built instead from Chinese customs data, calibrated against the finding that around [73 per cent of Chinese exports are installed](https://ember-energy.org/latest-insights/the-take-off-in-african-solar-that-official-statistics-cant-yet-see/), with an average delay of about six months.
...
The instrument works because [94 per cent of panels](https://ember-energy.org/latest-insights/the-take-off-in-african-solar-that-official-statistics-cant-yet-see/) installed in Africa are still imported from China. It is an artefact of dependence. And it therefore has a property that deserves more attention than it has received: **its accuracy degrades in direct proportion to Africa's success at building its own industry.**

That is not hypothetical. African panel manufacturing is expected to [quadruple to around 3.5 gigawatts in 2026](https://ember-energy.org/latest-insights/the-take-off-in-african-solar-that-official-statistics-cant-yet-see/), roughly a fifth of what the continent installs, led by new plants in Egypt and Tanzania. Ember also notes that large Chinese cell and wafer shipments to Africa appear to indicate [re-shipment rather than panel manufacturing](https://ember-energy.org/latest-insights/the-take-off-in-african-solar-that-official-statistics-cant-yet-see/), which means the signal is already partly contaminated.
...
## Substitution before electrification

The second thing the number cannot tell you is who is buying, and there is a strong clue in the economics.

Ember puts a year of Chinese panel imports at around [2.4 billion dollars](https://ember-energy.org/latest-insights/the-take-off-in-african-solar-that-official-statistics-cant-yet-see/), and notes that generating the same electricity from diesel would cost approximately that every three months. It also observes that Africa now imports [more dollars of batteries than solar panels](https://ember-energy.org/latest-insights/the-take-off-in-african-solar-that-official-statistics-cant-yet-see/) from China, led by Nigeria and the DRC.
...
## The planning problem, which is already visible elsewhere
...
The reason that question is urgent is that utilities are forecasting demand against a base that is quietly eroding, and in most of these countries they cannot see it happening. We described [the same dynamic in South Africa yesterday](/insight-customers-who-can-leave), where the departure of the largest and most creditworthy customers has been visible for years because the country has the reporting to see it. The rest of the continent is running the same process without the instruments.

The practical risks are specific. Thermal capacity procured under long term contracts against demand forecasts that do not include twenty gigawatts of invisible distributed solar becomes idle capacity that somebody still pays for, which is precisely the [take-or-pay problem](/insight-paying-for-what-we-curtail) that has made Kenyan electricity expensive. Network investment gets sized for a load shape that no longer applies. And revenue shortfalls arrive as a surprise in the accounts rather than as a line in a forecast.

Distributed solar is not the cause of these problems. Invisibility is.

---

## Closing the gap, and why nobody has
...
Those are field questions, and they are the ones we would ask. The [reliability calculation a business or a household is actually making](/insight-absorbing-the-gap) is the thing that decides whether this boom is an industrial cost reduction, an access transformation, or both in different places. It is not currently being measured anywhere, and it would not take much to start.

The Lab works on this in [energy access](/expertise-energy), across the markets where the boom is fastest, and through [field research](/field-research) designed to answer the questions a dataset structurally cannot.

If you are planning generation, financing a network, or writing an access strategy against these numbers, [the three questions above are worth answering first](/contact).
