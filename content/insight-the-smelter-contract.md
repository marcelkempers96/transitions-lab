...
The Akosombo Dam was completed in 1965 with an initial capacity of around [912 megawatts](https://www.britannica.com/topic/Akosombo-Dam), built to power Ghana's industrialisation. Its financing was closely tied to a commitment from the Volta Aluminium Company, a venture dominated by Kaiser Aluminum, whose smelter provided the anchor demand the international financiers required. Valco secured [low-cost power for a period of thirty years](https://drupal.oxfordbusinessgroup.com/overview/generating-momentum-plans-improve-connectivity-and-gas-supply-hope-help-boost-power-sector-and), at rates below what Ghanaian households and other industries paid, alongside substantial tax concessions.

Four things followed over the subsequent decades.

**The downstream industry did not arrive.** The smelter [processed imported bauxite rather than Ghana's own reserves](https://www.britannica.com/topic/Akosombo-Dam), so the integrated aluminium industry the project was meant to create never materialised. Ghana supplied the electricity and imported the raw material.
...
**The load left.** Valco [closed completely in May 2003 over its inability to agree an electricity price](https://drupal.oxfordbusinessgroup.com/overview/generating-momentum-plans-improve-connectivity-and-gas-supply-hope-help-boost-power-sector-and), restarted in 2006, shut again between 2007 and 2011, and passed into government ownership.

**The costs were not only financial.** Filling the reservoir submerged around seven hundred villages and displaced roughly eighty thousand people, and [altered the ecology of the Lower Volta and the livelihoods of hundreds of thousands](https://muse.jhu.edu/book/112022).
...
<div class="callout c-forest">
  <span class="kicker">Who is committed for how long</span>
  <p>Asset lives run on very different clocks, and the mismatch is what gives the counterparty its leverage at renegotiation.</p>
  <ul>
    <li><strong>Compute commitment:</strong> six years. The counterparty's exposure.</li>
    <li><strong>Data centre building:</strong> ten to fifteen years. Also the counterparty's.</li>
    <li><strong>Substation and transformers:</strong> around forty years. The host's.</li>
    <li><strong>Transmission line:</strong> around fifty years. The host's.</li>
    <li><strong>Major generation asset:</strong> a century, as at Akosombo, still operating. The host's.</li>
  </ul>
  <p>Two of the five sit with the customer. The other three sit with the region and outlast the contract by decades. Everything blue is what the host is left holding.</p>
</div>
...
What [travels with a large industrial operator](/insight-incumbents-second-life) into a region includes its assumptions about who bears risk. This is a version of the same bargain we described in [platform-anchored infrastructure](/insight-anchor-tenant), scaled up to a national grid and a state government.

The Lab works on this across [energy access](/expertise-energy) and [AI and digital systems](/expertise-ai-digital), and on what large deployments mean for the places that host them.

If you are negotiating an anchor-load agreement, the terms above are worth putting on the table while you still have the leverage to ask. [Tell us what you need to know](/contact).

---

## Sources

- [Anthropic](https://www.anthropic.com/) and [Nscale](https://www.nscale.com/), US$45 billion, six-year compute agreement using [Nvidia](https://www.nvidia.com/) Vera Rubin systems, with around 460 megawatts of load at the West Virginia site, August 2026 (contract value, term and site capacity are as reported by the two companies).
- Britannica, [Akosombo Dam](https://www.britannica.com/topic/Akosombo-Dam).
- Oxford Business Group, [Ghana power sector overview](https://drupal.oxfordbusinessgroup.com/overview/generating-momentum-plans-improve-connectivity-and-gas-supply-hope-help-boost-power-sector-and), 2019.
- Miescher, S. F., [*A Dam for Africa: Akosombo Stories from Ghana*](https://muse.jhu.edu/book/112022), Indiana University Press.
