...
<figure>
<img src="/assets/img/insight-incumbents-second-life-diagram.jpg" alt="Line-art diagram: on the left a large grey legacy factory with smokestacks; a dotted arc carries a toolbox containing a gear and a wrench across the middle, past a faint ghost of the same factory; on the right a cleaner facility with solar panels, a wind turbine and small trees." class="diagram">
<figcaption>The engineering capability in the crate travels with the incumbent into the new regime. The routines and conduct behind it move at the same time, and are checked less.</figcaption>
</figure>
