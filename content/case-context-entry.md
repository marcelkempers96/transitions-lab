...
<figure>
  <img src="/assets/img/case-context-entry-hero.jpg" alt="Two commercial riders on electric motorcycles queue at a modern charging column beside a Lagos street forecourt, while a fruit vendor with a covered stall and jerry cans of fuel serves customers on the opposite side of the same yard." class="diagram">
  <figcaption>A single frame, two economies at the same forecourt. Market-entry work is the discipline of understanding which of the two the new product actually enters, and on what terms.</figcaption>
</figure>
