...
The clearest evidence for this remains Koenecke and colleagues in 2020, who tested five commercial systems from Amazon, Apple, Google, IBM and Microsoft against [structured interviews with 42 white and 73 black speakers across five US cities](https://doi.org/10.1073/pnas.1915768117). Error rates for Black speakers were [roughly double those for white speakers, and the disparity appeared across every system tested](https://doi.org/10.1073/pnas.1915768117). The researchers located the gap in the [acoustic models rather than the language models, indicating the systems were confused by phonological and prosodic characteristics rather than by grammar or vocabulary](https://doi.org/10.1073/pnas.1915768117). Error rate rose with dialect density: [the more a speaker exhibited features characteristic of the variety, the worse the transcription](https://doi.org/10.1073/pnas.1915768117).
