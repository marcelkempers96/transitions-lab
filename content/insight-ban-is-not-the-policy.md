...
This is the same governance question we set out about [an open battery swapping standard](/insight-who-holds-the-pen), arriving in mineral processing. Whoever controls the only facility that everyone must use is a regulator whether or not anybody has said so.

<div class="callout c-butter">
  <span class="kicker">What has to be true on the day the ban lands</span>
  <p>Five conditions govern whether an export restriction transfers value to a country or destroys revenue on the way to concentrating it inside one company.</p>
  <ul>
    <li><strong>Processing capacity commissioned and running.</strong> Reportedly one plant is operational in Zimbabwe.</li>
    <li><strong>Open to third party material on published terms.</strong> Reportedly not, and this is the row that decides who benefits.</li>
    <li><strong>Power, reagents and logistics in place.</strong> Only partly.</li>
    <li><strong>A buyer contracted for the intermediate product.</strong> Unclear from public sources.</li>
    <li><strong>A government that has not previously relented.</strong> Relented in 2024 when prices fell.</li>
  </ul>
  <p>Fail the first three and the policy destroys export revenue. Fail the second alone and it transfers value between domestic producers rather than capturing it for the country.</p>
</div>
...
The Lab works on this in [local manufacturing](/expertise-manufacturing) and across the regions where processing capacity is being built for the first time. The distance between a policy announcement and an operating industrial system is the thing we measure.

If you are assessing a beneficiation programme against a legislated deadline, [tell us what you need to know](/contact).

---

## Sources

- Mining.com, [Zimbabwe to ban export of lithium concentrates from 2027](https://www.mining.com/web/zimbabwe-to-ban-export-of-lithium-concentrates-from-2027/), June 2025.
- S&P Global, [Zimbabwe to ban lithium concentrate exports from 2027 to boost refining](https://www.spglobal.com/energy/en/news-research/latest-news/metals/061125-zimbabwe-to-ban-lithium-concentrate-exports-from-2027-to-boost-refining), June 2025.
- Gotion Power Morocco battery plant at Kenitra and [African Development Bank](https://www.afdb.org/) financing (as reported), August 2026.
- Kydland, F. and Prescott, E. (1977), "Rules Rather than Discretion: The Inconsistency of Optimal Plans", *Journal of Political Economy* 85(3).

---

*This is an independent insight piece by Transitions Lab. For the Lab's applied work, see [Local Manufacturing & Supply Chains](/expertise-manufacturing). See also [The Lock-In Runs Both Ways](/insight-lock-in-both-ways) on qualification as the barrier above lithium sulphate, [Who Holds the Pen](/insight-who-holds-the-pen) on the same monopsony question in an open standard, and [Capability Is the Slow Part](/insight-capability-slow-part) on the decade it takes for local integration to appear as capability. To discuss a study, see [Contact](/contact).*
