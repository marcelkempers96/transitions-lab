...
- Africa's manufacturing value-added grew from **$285bn (2020) to $351bn (2025)**, yet the continent is still under **2% of global output** (AfDB).
- Manufacturing is about **10.4% of continental GDP**, well below the **20%** UNIDO ties to real structural transformation.
- Each manufacturing job generates, on average, around **2.5 additional jobs** elsewhere (UNIDO).
