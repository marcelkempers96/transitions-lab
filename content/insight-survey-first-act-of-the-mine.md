...
<figure>
<img src="/assets/img/insight-survey-first-act-of-the-mine-hero.jpg" alt="Line-art scene: a small satellite in orbit above a curved section of the earth, emitting two distinct beams towards the ground, one drawn as straight optical rays and one as concentric radar arcs, passing through a band of cloud. Below, a landscape of hills and river valleys rendered in fine contour lines, with a locked archive cabinet standing at the edge of the frame between the landscape and a group of small figures." class="diagram">
<figcaption>Two ways of seeing the same ground, and a cabinet that decides who is shown it.</figcaption>
</figure>
...
We argued in [The Ban Is Not the Policy](/insight-ban-is-not-the-policy) that an export restriction only transfers value if processing capacity actually exists when the restriction bites. Data sequencing is the same instrument acting earlier and more cheaply, because withholding a survey costs nothing and stops nothing that is already running.

<aside class="tl-box">
<p><strong>A databank is a governance institution wearing technical clothes.</strong></p>
<p>The moment a state holds the only copy of information worth billions, it has created something that needs governing more carefully than a mine does.</p>
<p>Who inside the ministry can grant access, on what criteria, recorded how. Whether the tiers are published or negotiated case by case. What a refused applicant can appeal to. Whether the data is escrowed against the possibility that a future administration sells it cheaply. And whether the survey contractor, who by definition holds a copy, is bound by anything durable.</p>
<p>None of that is geology and all of it decides whether the asset works. An information asset with weak access governance is worse than no asset at all, because its value is entirely in exclusivity, and exclusivity is destroyed by a single leak that nobody can prove happened.</p>
<p>The uncomfortable version: a state databank concentrates in one office a bargaining advantage that used to be dispersed across dozens of separate negotiations. That is the point of it, and it is also a concentration of something worth capturing.</p>
</aside>
...
**The survey has to be usable, not merely held.** Airborne data requires processing, interpretation and geologists who can convert an anomaly into a prospect. A ministry holding raw datasets it cannot interpret has bought a filing cabinet. The interpretive capability is the [slow part](/insight-capability-slow-part) and it should be budgeted alongside the flying, not after it.

**Access rules should be published before the first application.** The difference between an industrial policy instrument and a discretionary favour is whether the terms exist in writing beforehand. This is the same [third-party access question](/insight-symbiosis-not-a-site-plan) that determines whether shared infrastructure builds an ecosystem or concentrates one.
...
The Lab works on this in [local manufacturing](/expertise-manufacturing) and [climate and ecosystems](/expertise-climate), and on what an extractive decision means for the region it lands in through [entering a new context](/entering-a-new-context).

If you are advising a government on how to use geological information as an instrument rather than an archive, [tell us what you need to know](/contact).

---

## Sources

- Democratic Republic of Congo national geological mapping and databank programme (as reported), September 2026.
- GalaxEye patent for synchronised optical and radar satellite imaging (as reported), September 2026.
...
- [Summary of Arrow's treatment of information as a commodity](https://acawiki.org/Economic_welfare_and_the_allocation_of_resources_for_invention).

---

*This is an independent insight piece by Transitions Lab. For the Lab's applied work, see [Local Manufacturing & Supply Chains](/expertise-manufacturing). See also [The Ban Is Not the Policy](/insight-ban-is-not-the-policy) on why an export restriction only works when processing capacity exists, [The Value Is in the Second Step](/insight-second-step) on where the value in a mineral chain actually sits, and [Capability Is the Slow Part](/insight-capability-slow-part) on why interpretive capability takes a decade to build. To discuss a study, see [Contact](/contact).*
