  ...
  <div class="wrap">
    ...
    <div class="insight-row">
      ...
      <a class="insight-card has-photo desktop-only" href="/insight-warm-house-not-cheaper">
        <div class="card-photo">
          <img src="/assets/img/insight-warm-house-not-cheaper-diagram.jpg" alt="Three houses in sequence: on the left, a cold, leaky home with wavy blue draught lines and a shivering figure inside; in the middle, a home under retrofit with a worker installing insulation and a heat pump outside; on the right, a warm home with the light on and a family sitting together on the sofa.">
      ...
      <a class="insight-card has-photo desktop-only" href="/insight-enough-demonstrations">
        <div class="card-photo">
          <img src="/assets/img/insight-enough-demonstrations-diagram.jpg" alt="Three panels connected by dashed arrows: on the left, a small demonstration plot with a tree, a pond and a few rows of crops; in the middle, a clipboard with ticked items above three coloured figures representing the project team; on the right, a wide landscape at scale with a village of houses, a wind turbine, a water tower and solar panels sitting alongside patchworked fields.">
