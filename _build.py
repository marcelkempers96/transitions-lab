...
<!-- NETWORK - global field team + academic base -->
<section class="section-forest" style="color:var(--paper);">
  <div class="wrap">
    <div class="section-head reveal">
      ...
      <p style="color:var(--paper);">The Lab is a small core in Delft and a wider network of trained field researchers, local analysts, and long-standing partners in the places we work. We do not parachute in, and we do not run studies at arm's length.</p>
    </div>
    <div class="network-grid">
      <div class="network-card">
        <div class="net-num">01</div>
        <h3>A Delft core, and a global bench</h3>
        <p>Our researchers speak the language, know the market, and have context that a fly-in team never accumulates. New geographies are staffed from existing relationships, not job boards.</p>
      </div>
      <div class="network-card">
        <div class="net-num">02</div>
        <h3>Anchored in the research community</h3>
        <p>Based alongside <a href="https://www.tudelft.nl/" target="_blank" rel="noopener">TU Delft</a>, the Lab is close to the academic communities that produce the frameworks we use, and open enough to publish its own work back.</p>
      </div>
      <div class="network-card">
        <div class="net-num">03</div>
        <h3>Partners on the ground</h3>
        <p>Long-standing engagements with named partners like <a href="/case-roam">Roam</a>, <a href="/case-mimaji">MiMaji</a>, <a href="/case-pyropower">Pyropower</a>, and <a href="/case-reef-support">Reef Support</a>, plus a wider bench of local research organisations in East Africa, Southeast Asia, and the Dutch Caribbean.</p>
      </div>
    </div>
  </div>
</section>
