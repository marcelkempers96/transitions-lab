...
<section class="section-paper theory-maps-section">
  <div class="wrap">
    <div class="section-head reveal" style="margin-bottom:24px;">
      <p class="eyebrow">Theory maps</p>
      <h2 style="font-size:28px;">Four lenses on the same terrain.</h2>
      <p style="max-width:640px;">The Lab uses four theory references in the field: the behaviour of real people, the economics of the deal, the strategy of the technology, and the shape of the system as a whole. Each map, each anchored to its canonical sources.</p>
    </div>
